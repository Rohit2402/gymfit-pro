        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              memberships, workouts, or feedback, reach out anytime. Our team is
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        For inquiries & emergency support
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">support@gymfitpro.com</p>
                      <p className="text-sm text-gray-500">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-4">
                  Follow Us for Fitness Tips & Updates!
                </h3>
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="w-12 h-12 bg-pink-500 hover:bg-pink-600 rounded-lg flex items-center justify-center transition duration-300">
                    <svg
                      className="h-6 w-6 text-white"
                      fill="currentColor"
                      viewBox="0 0 24 24">
                  ...
                  <a
                    href="#"
                    className="w-12 h-12 bg-red-500 hover:bg-red-600 rounded-lg flex items-center justify-center transition duration-300">
                    <svg
                      className="h-6 w-6 text-white"
                      fill="currentColor"
                      viewBox="0 0 24 24">
                  ...
                  <a
                    href="#"
                    className="w-12 h-12 bg-gray-800 hover:bg-gray-900 rounded-lg flex items-center justify-center transition duration-300">
                    <svg
                      className="h-6 w-6 text-white"
                      fill="currentColor"
                      viewBox="0 0 24 24">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300 resize-none ${
                      errors.message
                        ? "border-red-300 bg-red-50"
                        : "border-gray-300"
                    }`}
            ...
            <div className="bg-white rounded-xl shadow-lg p-4">
              <div className="w-full h-96 bg-gray-200 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <a
                    href="https://maps.google.com/?q=123+Fitness+Street,+Gym+City,+GC+12345"
                    target="_blank"
